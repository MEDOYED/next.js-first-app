    ...
    <main className={style.main}>
      <div className={style.container}>
        <section className={style.section}>
          <Image className={style.image} src= "/home/japan.jpg" width={700} height={500}  alt="japan image" />
          <div>
        ...
        <section className={style.section}>
          <Image className={style.image} src="/home/brazil.jpg" width={700} height={500}  alt="brazil image" />
          <div>
        ...
        <section className={style.section}>
          <Image className={style.image} src="/home/canada.jpg" width={700} height={500}  alt="canada image" />
        ...
        <section className={style.section}>
          <Image className={style.image} src="/home/australia.avif" width={700} height={500}  alt="australia image" />
          <div>
