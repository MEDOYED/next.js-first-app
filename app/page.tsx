    ...
    <main className={style.main}>
      <div className={style.container}>
        <section className={style.section}>
          <Image className={style.image} src= "/home/japan.jpg" alt="japan image" />
          <div>
        ...
        <section className={style.section}>
          <Image className={style.image} src="/home/brazil.jpg" alt="brazil image" />
          <div>
        ...
        <section className={style.section}>
          <Image className={style.image} src="/home/canada.jpg" alt="canada image" />
        ...
        <section className={style.section}>
          <Image className={style.image} src="/home/australia.avif" alt="australia image" />
          <div>
